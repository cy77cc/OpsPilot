...
- [ ] **Step 2: Add the migration with exact tables and indexes**
...
- [ ] **Step 3: Update chat/message models only where Phase 1 needs it**
...
- [ ] **Step 1: Write the failing DAO tests or handler-level expectations**
...
- [ ] **Step 2: Implement minimal DAO methods**
...
- [ ] **Step 2: Implement `internal/service/ai/routes.go` and wire it into `internal/service/service.go`**

Follow the registration style used by other service modules under `internal/service/*/routes.go`.

- [ ] **Step 3: Add placeholder handlers with stable response types**
...
- [ ] **Step 2: Implement minimal handlers using DAOs**
...
- [ ] **Step 1: Write failing tests for run status and SSE event serialization**
...
- [ ] **Step 2: Implement the stream event envelope**
...
- [ ] **Step 3: Implement the run status handler**
...
- [ ] **Step 1: Write failing chat execution tests**
...
- [ ] **Step 2: Remove or de-emphasize old public APIs that conflict with Phase 1**

At minimum, do not let chains/approvals/execution-detail contracts remain the main path used by the UI.

- [ ] **Step 3: Implement the new typed client surface**
...
- [ ] **Step 2: Implement the new page and focused child components**
...
- [ ] **Step 1: Write the failing report-page test**
...
- [ ] **Step 2: Implement the report page**
...
- [ ] **Step 2: Implement the minimal retirement path**
...
- [ ] **Step 2: Remove or isolate legacy event dependencies**
...
- [ ] **Step 2: Fix the smallest failing unit first**
...
- [ ] **Step 1: Update the spec and plan if implementation changed a contract**

Only document real deviations.

- [ ] **Step 2: Capture the final removed paths**

List which old AI entry points, event names, or models are no longer public.

- [ ] **Step 3: Run final smoke verification**
