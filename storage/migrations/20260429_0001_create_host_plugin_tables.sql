...
CREATE TABLE host_plugin_config_revisions (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY idx_host_plugin_config_revisions_instance_id (instance_id)
);
...
CREATE TABLE host_plugin_tasks (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY idx_host_plugin_tasks_instance_id (instance_id),
  KEY idx_host_plugin_tasks_status (status)
);
...
CREATE TABLE host_plugin_task_logs (
  ...
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  KEY idx_host_plugin_task_logs_task_id (task_id)
);
