...
//
// 返回: 错误信息
func (d *AICheckpointDAO) Upsert(ctx context.Context, checkpoint *AICheckpoint) error {
...
//
// 返回: 检查点记录或 nil（不存在时）
func (d *AICheckpointDAO) Get(ctx context.Context, checkpointID string) (*AICheckpoint, error) {
