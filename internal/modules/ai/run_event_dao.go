...
// Create 创建新的事件记录。
func (d *AIRunEventDAO) Create(ctx context.Context, event *AIRunEvent) error {
...
//
// 返回: 事件列表
func (d *AIRunEventDAO) ListByRun(ctx context.Context, runID string) ([]AIRunEvent, error) {
...
//
// 返回: 事件或 nil（不存在时）
func (d *AIRunEventDAO) FindByEventID(ctx context.Context, runID, eventID string) (*AIRunEvent, error) {
...
func (d *AIRunEventDAO) ListAfterEventID(ctx context.Context, runID, lastEventID string) ([]AIRunEvent, error) {
	normalizedRunID := strings.TrimSpace(runID)
