...
func (d *AIDiagnosisReportDAO) CreateReport(ctx context.Context, report *AIDiagnosisReport) error {
...
//
// 返回: 诊断报告或 nil（不存在时）
func (d *AIDiagnosisReportDAO) GetReport(ctx context.Context, reportID string) (*AIDiagnosisReport, error) {
	var report AIDiagnosisReport
...
//
// 返回: 诊断报告或 nil（不存在时）
func (d *AIDiagnosisReportDAO) GetReportByRunID(ctx context.Context, runID string) (*AIDiagnosisReport, error) {
	var report AIDiagnosisReport
