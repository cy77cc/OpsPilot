...
//
// 返回: 错误信息
func (d *AIRunProjectionDAO) Upsert(ctx context.Context, projection *AIRunProjection) error {
...
//
// 返回: 投影记录或 nil（不存在时）
func (d *AIRunProjectionDAO) GetByRunID(ctx context.Context, runID string) (*AIRunProjection, error) {
	var projection AIRunProjection
