...
func (h *HTTPHandler) dao() *rootai.LLMProviderDAO {
	if h == nil || h.db == nil {
		return nil
	}
	return rootai.NewLLMProviderDAO(h.db)
}
...
func NewDAO(db *gorm.DB) *rootai.LLMProviderDAO {
	return rootai.NewLLMProviderDAO(db)
}
