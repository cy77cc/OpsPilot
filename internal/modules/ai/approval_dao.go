...
// Create 创建审批任务。
func (d *AIApprovalTaskDAO) Create(ctx context.Context, task *AIApprovalTask) error {
	return d.db.WithContext(ctx).Create(task).Error
}

// GetByApprovalID 根据 ApprovalID 获取审批任务。
func (d *AIApprovalTaskDAO) GetByApprovalID(ctx context.Context, approvalID string) (*AIApprovalTask, error) {
	var task AIApprovalTask
...
func (d *AIApprovalTaskDAO) GetByCheckpointID(ctx context.Context, checkpointID string) (*AIApprovalTask, error) {
	var task AIApprovalTask
	err := d.db.WithContext(ctx).
...
func (d *AIApprovalTaskDAO) ListPendingByUserID(ctx context.Context, userID uint64, limit int) ([]AIApprovalTask, error) {
	var tasks []AIApprovalTask
...
func (d *AIApprovalTaskDAO) ListPending(ctx context.Context, limit int) ([]AIApprovalTask, error) {
	var tasks []AIApprovalTask
	query := d.db.WithContext(ctx).
