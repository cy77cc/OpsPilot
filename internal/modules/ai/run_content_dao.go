...
// Create 创建新的内容记录。
func (d *AIRunContentDAO) Create(ctx context.Context, content *AIRunContent) error {
...
//
// 返回: 内容记录或 nil（不存在时）
func (d *AIRunContentDAO) Get(ctx context.Context, id string) (*AIRunContent, error) {
	var content AIRunContent
