...
type ModelFactory interface {
	Create(ctx context.Context, provider *ai.AILLMProvider, opts ChatModelConfig) (einomodel.ToolCallingChatModel, error)
}
...
func NewChatModelFromProvider(ctx context.Context, provider *ai.AILLMProvider, opts ChatModelConfig) (einomodel.ToolCallingChatModel, error) {
	if provider == nil {
