...
func staticCatalogEntries() []ToolMetadata {
	return []ToolMetadata{
		...
		{ToolName: "k8s_query", Domain: "kubernetes", Capability: "query", RiskLevel: "low", OutputMode: "inline", Description: "query kubernetes resources", DirectlyCallable: false, AccessPath: "specialist_or_runtime_dispatch"},
