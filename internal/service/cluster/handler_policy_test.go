...
func TestRoutePolicy_RegistersPolicyReleaseAndCNIInfoRoutes(t *testing.T) {
	gin.SetMode(gin.TestMode)
	handler, _ := newOperationHistoryTestHandler(t)
	...
	want := []struct {
		...
		{method: http.MethodGet, path: "/api/v1/clusters/:id/cni-info"},
		{method: http.MethodPost, path: "/api/v1/clusters/:id/policies/:namespace/:name/releases"},
		{method: http.MethodGet, path: "/api/v1/clusters/:id/releases/:release_id"},
		{method: http.MethodPost, path: "/api/v1/clusters/:id/releases/:release_id/apply"},
		{method: http.MethodPost, path: "/api/v1/clusters/:id/releases/:release_id/rollback"},
	}
