...
// Import shared policy types from contracts
...
// Re-export constants from domain/policy
const (
	PolicyDefinitionAPIVersion       = clusterpolicy.PolicyDefinitionAPIVersion
	PolicyDefinitionKind             = clusterpolicy.PolicyDefinitionKind
	PolicyErrorFlannelNetpolDisabled = clusterpolicy.PolicyErrorFlannelNetpolDisabled
)
...
// Re-export functions from domain/policy
var ObservePolicyReleaseDuration = clusterpolicy.ObservePolicyReleaseDuration
