...
// ClusterCNIInfoRecord holds CNI information for a cluster.
...
func NewRepository(db *gorm.DB) *Repository {
	...
	repo.Phase3 = clustersecurity.NewPhase3Repository(db)
	return repo
}
...
// decodeJSONStringMap 解析 JSON 字符串为 map。
...
func toBootstrapProfileItem(row model.ClusterBootstrapProfile) BootstrapProfileItem {
	return BootstrapProfileItem{
		...
		ExternalEtcd:         nil, // TODO: parse row.ExternalEtcdJSON
