...
func TestRouteRuntime_RegistersSecurityRoutes(t *testing.T) {
	gin.SetMode(gin.TestMode)
	handler, _ := newPhase3RuntimeTestHandler(t, ClusterModePlatformManaged)
	...
	want := []struct {
		...
		{method: http.MethodPost, path: "/api/v1/clusters/:id/security/events/ingest"},
		{method: http.MethodGet, path: "/api/v1/clusters/:id/security/alerts"},
		{method: http.MethodGet, path: "/api/v1/clusters/:id/security/events/:event_id"},
		{method: http.MethodPost, path: "/api/v1/clusters/:id/security/alerts/:alert_id/resolve"},
		{method: http.MethodPost, path: "/api/v1/clusters/:id/security/alerts/:alert_id/contain"},
	}
