...
//
// 本文件实现命名空间管理相关的 HTTP Handler，包括命名空间列表查询、
// 创建、删除以及团队绑定等功能。
package handler
...
//
// @Summary 获取命名空间列表
// @Description 获取指定集群的命名空间列表，支持团队权限过滤
// @Tags 集群管理-命名空间
// @Accept json
// @Produce json
...
// @Param Authorization header string true "Bearer Token"
// @Param X-Team-ID header string false "团队 ID"
// @Param request body map[string]interface{} true "命名空间创建请求"
// @Success 200 {object} httpx.Response
...
// @Failure 401 {object} httpx.Response
// @Failure 500 {object} httpx.Response
// @Router /clusters/{id}/namespaces/{name} [delete]
...
// ListNamespaceBindings 获取命名空间绑定列表。
//
// @Summary 获取命名空间绑定列表
...
// @Produce json
// @Param id path int true "集群 ID"
// @Param team_id query string false "团队 ID"
// @Param Authorization header string true "Bearer Token"
// @Success 200 {object} httpx.Response
// @Failure 401 {object} httpx.Response
// @Failure 500 {object} httpx.Response
// @Router /clusters/{id}/namespace-bindings [get]
...
// @Param Authorization header string true "Bearer Token"
// @Param request body map[string]interface{} true "绑定请求"
// @Success 200 {object} httpx.Response
// @Failure 400 {object} httpx.Response
// @Failure 401 {object} httpx.Response
// @Failure 500 {object} httpx.Response
// @Router /clusters/{id}/namespace-bindings/{teamId} [put]
