...
type BootstrapProfileItem = clusterlogic.BootstrapProfileItem
type BootstrapProfileCreateReq = clusterlogic.BootstrapProfileCreateReq
type BootstrapProfileUpdateReq = clusterlogic.BootstrapProfileUpdateReq

// Import cache functions from logic
var CacheKeyBootstrapProfiles = clusterlogic.CacheKeyBootstrapProfiles
