...
const ClusterConfigStoragePage = lazy(() => import('./pages/Deployment/Infrastructure/ClusterConfigStoragePage'));
...
const AIModelSettingsPage = lazy(() => import('./pages/Settings/AIModelSettingsPage'));
